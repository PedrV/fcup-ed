...
public class BSTMap1<K extends Comparable<? super K>,V> {   
   private BSTMapNode1<K,V> root; // raiz da arvore
   ...
   public BSTMapNode1<K,V> getRoot() {return root;}
   public void setRoot(BSTMapNode1<K,V> r) {root = r;}
   ...
   private int size(BSTMapNode1<K,V> n) {
      if (n == null) return 0;
   ...
   private V get(BSTMapNode1<K,V> n, K key) {
   ...
   private BSTMapNode1<K,V> put(BSTMapNode1<K,V> n, K key, V value) {
      if (n==null)
         return new BSTMapNode1<K,V>(key, value, null, null);
   ...
   private BSTMapNode1<K,V> remove(BSTMapNode1<K,V> n, K key) {
   ...
   private void keys(BSTMapNode1<K,V> n, LinkedList<K> l) {
      if (n==null) return;
      keys(n.getLeft(), l);
      l.addLast(n.getKey());
      keys(n.getRight(), l);
